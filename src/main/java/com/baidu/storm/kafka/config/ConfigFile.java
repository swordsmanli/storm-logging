...
public class ConfigFile {
	...
	//Kafka
	public static String KFK_SERV_HOSTS = "10.65.45.98:9092,10.36.34.11:20000";
	public static int KFK_SERV_PORT = 9092;
	public static int KFK_BUFFER_SIZE = 10*1024*1024;
	public static int KFK_PART_NUMS = 1;
	public static String KFK_GROUP_ID = "vsp_log";
	public static String KFK_TOPIC = "vsp";
	...
	//Zookeeper
	public static String ZK_ROOT = "/kafka_storm_vsp";
	...
	public static String MONGO_COLL_NAME = "vsp";
